        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <div className="bg-amber-500 text-white rounded-full w-10 h-10 flex items-center justify-center font-bold text-lg">
                R
              </div>
              <div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/" className="text-gray-300 hover:text-amber-500 transition-colors text-sm">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/services" className="text-gray-300 hover:text-amber-500 transition-colors text-sm">
                  Services
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-gray-300 hover:text-amber-500 transition-colors text-sm">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-gray-300 hover:text-amber-500 transition-colors text-sm">
                  Contact
                </Link>
              </li>
              <li>
                <Link href="/booking" className="text-gray-300 hover:text-amber-500 transition-colors text-sm">
                  Book Online
                </Link>
              </li>
            </ul>
          ...
          {/* Services */}
          <div>
            <h3 className="font-semibold text-lg mb-4 text-amber-500">Our Services</h3>
            <ul className="space-y-2">
          ...
          {/* Contact Information */}
          <div>
            <h3 className="font-semibold text-lg mb-4 text-amber-500">Contact Info</h3>
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a 
                  ...
                  className="text-gray-300 hover:text-amber-500 transition-colors text-sm break-all"
                >
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="text-gray-300 text-sm">
                  ...
                  <p className="text-amber-500">Sunday: Closed</p>
                </div>
              </div>
            </div>
          </div>
